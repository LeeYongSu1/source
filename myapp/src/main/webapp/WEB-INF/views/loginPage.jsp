	...
	<div class="container bootstrap snippets bootdey">
	    <div class="lc-block col-md-4 col-md-offset-4 toggled" id="l-login"  id="userId" name="userId">
	        ...
	        <div class="form-group mb-1">
	        	<button type="submit" class="btn btn-block btn-primary btn-float m-t-25">로그인</button>
	        </div>
	        <div class="form-group">
				<a href="${path}/register"><button id="registerBtn" type="button" class="btn btn-block btn-primary btn-float m-t-25">회원가입</button></a>
			</div>
	    </div>
	</div>
	</c:if>
