	...
	<div class="container">
		...
		<div class="form-group">
			...
			<c:if test="${member.userId == 'ly3029' }">
				<a href="${path}/edit?product_name=${vo.product_name}"><button type="button" id="btn_1">수정</button></a>
				<a href="${path}/delete?product_num=${vo.product_num } "><button type="button" id="btn_2">삭제</button></a>
			</c:if>
	</div>
</body>
</html>